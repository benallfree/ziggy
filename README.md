...
### Using with `laravel-haml` (and other Blade templating tools)

[laravel-haml](https://github.com/BKWLD/laravel-haml) provides HAML-based Blade templating. Be sure to register the laravel-haml service provider AFER Ziggy to ensure the `@route` custom directive is registered first.
